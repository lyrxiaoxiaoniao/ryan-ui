        ...
        Promise.all(
          files.map(file => {
            ...
            const filePath = path.resolve(
              desc,
              file.replace('component', fileName).replace('.ejs', '')
            )
...
function autoImport() {
  ...
  // // packages/ryan/component.ts 添加导出
  // const n2 = resolve('../packages/ryan/component.ts')
  // let res2 = fse.readFileSync(n2, { encoding: 'utf-8' })
  // res2 = res2.replace(`} from '@ryan/components'`, `, ${currentName} } from '@ryan/components'`)
  // res2 = res2.replace(`] as Plugin[]`, `, Ryan${currentName}] as Plugin[]`)
