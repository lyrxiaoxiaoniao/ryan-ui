<template>
  <div class="demo-collapse">
    <ryan-collapse v-model="activeName" accordion>
      <ryan-collapse-item name="1">
        <template #title> Consistency<RyanIcon class="header-icon" name="info-filled" /> </template>
        <div>
      ...
      <ryan-collapse-item title="Feedback" name="2">
        <div>
      ...
      <ryan-collapse-item title="Efficiency" name="3">
      ...
      <ryan-collapse-item title="Controllability" name="4">
        <div>
