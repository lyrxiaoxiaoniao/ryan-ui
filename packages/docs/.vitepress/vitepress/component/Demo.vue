    ...
    <div class="example">
      ...
      <div class="op-btns">
        <span class="op-btn" @click="handleCopy">
          <RyanIcon name="document-copy" />
        </span>
        <span class="op-btn" @click="toggleSourceVisible()">
          <RyanIcon name="arrow-left" />
          <RyanIcon name="arrow-right" style="margin-left: -2px" />
        </span>
...
import { RyanIcon, RyanMessage } from '@ryan/components'
import RyanCollapseTransition from '@ryan/components/collapse-transition'
